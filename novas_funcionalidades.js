...
window.startCameraScanner = function(targetInputId = null) {
    ...
    // Limpar área caso tenha sobrado lixo
    document.getElementById('camera-reader').innerHTML = '';

    html5Qrcode = new Html5Qrcode("camera-reader");
    
    // Configura para abrir direto a câmera traseira
    ...
    html5Qrcode.start(
        ...
        alert("Não foi possível iniciar a câmera. Verifique as permissões do navegador ou se o site está usando HTTPS.");
        closeCameraScanner();
    });
};
